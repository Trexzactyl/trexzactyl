...
use Trexz\Exceptions\Http\HttpForbiddenException;
use Trexz\Transformers\Api\Client\TaskTransformer;
use Trexz\Http\Requests\Api\Client\ClientApiRequest;
use Trexz\Http\Controllers\Api\Client\ClientApiController;
use Trexz\Exceptions\Service\ServiceLimitExceededException;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Trexz\Http\Requests\Api\Client\Servers\Schedules\StoreTaskRequest;
...
class ScheduleTaskController extends ClientApiController
{
     ...
     * @throws \Trexz\Exceptions\Service\ServiceLimitExceededException
     */
    public function store(StoreTaskRequest $request, Server $server, Schedule $schedule): array
    {
        $limit = config('trexz.client_features.schedules.per_schedule_task_limit', 10);
        ...
        /** @var \Trexz\Models\Task|null $lastTask */
        $lastTask = $schedule->tasks()->orderByDesc('sequence_id')->first();

        /** @var \Trexz\Models\Task $task */
