...
use Trexz\Services\Servers\StartupCommandService;
...
use Trexz\Http\Requests\Api\Client\Servers\Startup\GetStartupRequest;
use Trexz\Http\Requests\Api\Client\Servers\Startup\UpdateStartupVariableRequest;
...
class StartupController extends ClientApiController
{
    ...
    public function update(UpdateStartupVariableRequest $request, Server $server): array
    {
        ...
        /* @var \Trexz\Models\EggVariable $variable */
