...
use Trexz\Services\Subusers\SubuserCreationService;
use Trexz\Repositories\Wings\DaemonServerRepository;
use Trexz\Transformers\Api\Client\SubuserTransformer;
use Trexz\Http\Controllers\Api\Client\ClientApiController;
use Trexz\Exceptions\Http\Connection\DaemonConnectionException;
use Trexz\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use Trexz\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use Trexz\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use Trexz\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
     ...
     * @throws \Trexz\Exceptions\Service\Subuser\ServerSubuserExistsException
     * @throws \Trexz\Exceptions\Service\Subuser\UserIsServerOwnerException
     * @throws \Throwable
     */
    ...
    {
        /** @var \Trexz\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
