...
use Trexz\Helpers\Utilities;
use Illuminate\Http\JsonResponse;
use Trexz\Exceptions\DisplayException;
use Trexz\Repositories\Eloquent\ScheduleRepository;
use Trexz\Services\Schedules\ProcessScheduleService;
use Trexz\Transformers\Api\Client\ScheduleTransformer;
use Trexz\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Trexz\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use Trexz\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use Trexz\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use Trexz\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use Trexz\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    {
        /** @var \Trexz\Models\Schedule $model */
