...
use Trexz\Http\Requests\Api\Application\Eggs\GetEggRequest;
use Trexz\Exceptions\Http\QueryValueOutOfRangeHttpException;
use Trexz\Http\Requests\Api\Application\Eggs\GetEggsRequest;
use Trexz\Http\Requests\Api\Application\Eggs\StoreEggRequest;
use Trexz\Http\Requests\Api\Application\Eggs\DeleteEggRequest;
use Trexz\Http\Requests\Api\Application\Eggs\ExportEggRequest;
use Trexz\Http\Requests\Api\Application\Eggs\UpdateEggRequest;
...
class EggController extends ApplicationApiController
{
    ...
    public function store(StoreEggRequest $request): JsonResponse
    {
        ...
        $merged = array_merge($validated, [
            ...
            'author' => config('trexz.service.author'),
        ]);
