...
class DiscordController extends Controller
{
    ...
    public function callback(Request $request)
    {
        ...
        if (User::where('discord_id', $discord->id)->exists()) {
            ...
            if ($this->settings->get('trexz::discord:enabled') != 'true') {
                return;
            }
            ...
            $data = [
                ...
                'store_cpu' => $this->settings->get('trexz::registration:cpu', 0),
                'store_memory' => $this->settings->get('trexz::registration:memory', 0),
                'store_disk' => $this->settings->get('trexz::registration:disk', 0),
                'store_slots' => $this->settings->get('trexz::registration:slot', 0),
                'store_ports' => $this->settings->get('trexz::registration:port', 0),
                'store_backups' => $this->settings->get('trexz::registration:backup', 0),
                'store_databases' => $this->settings->get('trexz::registration:database', 0),
            ];
