...
class StoreController extends Controller
{
    ...
    /**
     * Render the Trexz store settings interface.
     */
    public function index(): View
    {
        ...
        return view('admin.trexz.store', [
            ...
            'earn_enabled' => $this->settings->get('trexz::earn:enabled', false),
            'earn_amount' => $this->settings->get('trexz::earn:amount', 1),
    ...
    public function update(StoreFormRequest $request): RedirectResponse
    {
        ...
        $this->alert->success('If you have enabled a payment gateway, please remember to configure them. <a href="https://docs.trexz.com">Documentation</a>')->flash();

        return redirect()->route('admin.trexz.store');
    }
}
