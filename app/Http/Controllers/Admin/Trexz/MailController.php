...
use Trexz\Notifications\MailTested;
use Trexz\Exceptions\DisplayException;
use Trexz\Http\Controllers\Controller;
use Illuminate\Contracts\Console\Kernel;
use Illuminate\View\Factory as ViewFactory;
use Illuminate\Support\Facades\Notification;
use Trexz\Providers\SettingsServiceProvider;
use Illuminate\Contracts\Encryption\Encrypter;
use Trexz\Http\Requests\Admin\Trexz\MailFormRequest;
...
class MailController extends Controller
{
    ...
    {
        return $this->view->make('admin.trexz.mail', [
