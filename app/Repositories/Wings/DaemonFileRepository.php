...
namespace Trexz\Repositories\Wings;
...
use Trexz\Exceptions\Http\Server\FileSizeTooLargeException;
...
class DaemonFileRepository extends DaemonRepository
{
     ...
     * @throws \Trexz\Exceptions\Http\Server\FileSizeTooLargeException
