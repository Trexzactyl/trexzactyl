...
class FindAssignableAllocationService
{
    ...
    {
        if (!config('trexz.client_features.allocations.enabled')) {
        ...
        // server.
        /** @var \Trexz\Models\Allocation|null $allocation */
    ...
    {
        $start = config('trexz.client_features.allocations.range_start', null);
        $end = config('trexz.client_features.allocations.range_end', null);
