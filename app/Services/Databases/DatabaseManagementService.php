...
use Trexz\Extensions\DynamicDatabaseConnection;
use Trexz\Repositories\Eloquent\DatabaseRepository;
use Trexz\Exceptions\Repository\DuplicateDatabaseNameException;
use Trexz\Exceptions\Service\Database\TooManyDatabasesException;
use Trexz\Exceptions\Service\Database\DatabaseClientFeatureNotEnabledException;
...
class DatabaseManagementService
{
     ...
     *
     * @see \Trexz\Services\Databases\DatabaseManagementService::generateUniqueDatabaseName()
     */
    ...
    {
        if (!config('trexz.client_features.databases.enabled')) {
     ...
     *
     * @throws \Trexz\Exceptions\Repository\DuplicateDatabaseNameException
     * @throws \Throwable
     */
