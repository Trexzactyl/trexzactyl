...
namespace Trexz\Console\Commands\Environment;

use Illuminate\Console\Command;
use Illuminate\Contracts\Console\Kernel;
use Trexz\Traits\Commands\EnvironmentWriterTrait;
...
class AppSettingsCommand extends Command
{
     ...
     *
     * @throws \Trexz\Exceptions\PterodactylException
     */
    public function handle(): int
    {
        ...
        $this->variables['APP_SERVICE_AUTHOR'] = $this->option('author') ?? $this->ask(
            'Egg Author Email',
            config('trexz.service.author', 'unknown@unknown.com')
        );
        ...
        $this->variables['PTERODACTYL_TELEMETRY_ENABLED'] = $this->option('telemetry') ?? $this->confirm(
            ...
            config('trexz.telemetry.enabled', true)
        ) ? 'true' : 'false';
