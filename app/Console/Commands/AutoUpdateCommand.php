...
namespace Trexz\Console\Commands;

use Trexz\Console\Kernel;
...
{
    protected const DEFAULT_URL = 'https://github.com/trexz/trexz/releases/%s/panel.tar.gz';

    protected $signature = 'p:auto-update
        {--user= : The user that PHP runs under. All files will be owned by this user.}
        {--group= : The group that PHP runs under. All files will be owned by this group.}
        {--url= : The specific archive to download.}
        {--release= : A specific Trexz version to download from GitHub. Leave blank to use latest.}';

    protected $description = 'Downloads a new archive for Trexz from GitHub and then executes the normal upgrade commands.';

    /**
     * Executes an upgrade command which will run through all of our standard
     * commands for Trexz and enable users to basically just download
    ...
    public function handle()
    {
        ...
        /** @var \Trexz\Console\Kernel $kernel */
