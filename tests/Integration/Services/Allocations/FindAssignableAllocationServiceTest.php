...
namespace Trexz\Tests\Integration\Services\Allocations;

use Trexz\Models\Allocation;
use Trexz\Tests\Integration\IntegrationTestCase;
use Trexz\Services\Allocations\FindAssignableAllocationService;
...
class FindAssignableAllocationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('trexz.client_features.allocations.enabled', true);
        config()->set('trexz.client_features.allocations.range_start', 0);
        config()->set('trexz.client_features.allocations.range_end', 0);
    }
    ...
    {
        $server = $this->createServerModel();
        config()->set('trexz.client_features.allocations.range_start', 5000);
        config()->set('trexz.client_features.allocations.range_end', 5005);
    ...
    public function testOnlyPortNotInUseIsCreated()
    {
        ...
        config()->set('trexz.client_features.allocations.range_start', 5000);
        config()->set('trexz.client_features.allocations.range_end', 5001);
    ...
    {
        $server = $this->createServerModel();
        config()->set('trexz.client_features.allocations.range_start', 'hodor');
        config()->set('trexz.client_features.allocations.range_end', 10);
        ...
        config()->set('trexz.client_features.allocations.range_start', 10);
        config()->set('trexz.client_features.allocations.range_end', 'hodor');
    ...
    {
        config()->set('trexz.client_features.allocations.enabled', false);
        $server = $this->createServerModel();
