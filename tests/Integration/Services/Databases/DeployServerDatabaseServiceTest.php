...
namespace Trexz\Tests\Integration\Services\Databases;
...
class DeployServerDatabaseServiceTest extends IntegrationTestCase
{
    ...
    {
        config()->set('trexz.client_features.databases.allow_random', true);
    ...
    public function testErrorIsThrownIfNoDatabaseHostsExistOnNode()
    {
        ...
        config()->set('trexz.client_features.databases.allow_random', false);
