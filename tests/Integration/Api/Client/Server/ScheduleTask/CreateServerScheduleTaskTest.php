...
namespace Trexz\Tests\Integration\Api\Client\Server\ScheduleTask;
...
class CreateServerScheduleTaskTest extends ClientApiIntegrationTestCase
{
    ...
    public function testTaskCanBeCreated(array $permissions)
    {
        ...
        /** @var \Trexz\Models\Schedule $schedule */
    ...
    {
        config()->set('trexz.client_features.schedules.per_schedule_task_limit', 2);
