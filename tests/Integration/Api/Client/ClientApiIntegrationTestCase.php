...
namespace Trexz\Tests\Integration\Api\Client;
...
use Trexz\Tests\Integration\TestResponse;
...
abstract class ClientApiIntegrationTestCase extends IntegrationTestCase
{
    ...
    protected function assertJsonTransformedWith(array $data, Model|EloquentModel $model)
    {
        ...
        $transformer = sprintf('\\Trexz\\Transformers\\Api\\Client\\%sTransformer', $reflect->getShortName());
