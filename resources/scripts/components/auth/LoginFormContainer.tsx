...
export default forwardRef<HTMLFormElement, Props>(({ title, ...props }, ref) => (
    <Container className={'relative'}>
        ...
        {title && <h2 css={tw`text-4xl text-center text-neutral-100 font-black uppercase tracking-tighter py-8`}>{title}</h2>}
        <FlashMessageRender css={tw`mb-4 px-1`} />
        <Form {...props} ref={ref} css={tw`relative z-10`}>
            <div css={tw`w-full bg-neutral-900/40 backdrop-blur-xl border border-neutral-700/50 shadow-2xl rounded-3xl p-10`}>
