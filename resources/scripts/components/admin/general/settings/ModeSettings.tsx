...
export default () => {
    ...
    return (
        <>
            ...
            >
                Standard mode enables all the typical features of Trexz, including our billing system, tickets, user
            ...
            <FeatureContainer noHeight icon={faTerminal} title={'Debug Mode'} image={<ServerSvg color={primary} />}>
                When Trexz is in Debug mode, all HTTP request data is exposed and errors are reported including
