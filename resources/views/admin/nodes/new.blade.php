        ...
        <div class="col-sm-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="form-label">Deployable via Trexz Store</label>
                        <div>
                            <div class="radio radio-success radio-inline">
                        ...
                        <p class="text-muted"><small>
                            This option allows you to control whether this node is visible via the Server Creation page of the Trexz Storefront.
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <p class="text-muted small">The brand name displayed in daemon console logs (e.g., "Trexz: server marked offline"). Enter <code>Pterodactyl</code>, <code>Trexz</code>, or your custom brand.</p>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <p class="text-muted small">Enter the directory where server files should be stored. Common values: <code>/var/lib/pterodactyl/volumes</code> (Pterodactyl default), <code>/var/lib/Trexz/volumes</code> (Trexz), or <code>/home/daemon-data</code> (for OVH). <strong>Make sure this directory exists on your node.</strong></p>
                        </div>
                        <div class="form-group col-md-6">
