...
@include('partials/admin.trexz.nav', ['activeTab' => 'coupons'])
...
@section('content')
    @yield('trexz::nav')
    <form action="{{ route('admin.trexz.coupons') }}" method="POST">
        <div class="row">
            <div class="col-xs-12">
    ...
    <form action="{{ route('admin.trexz.coupons.store') }}" method="POST">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
