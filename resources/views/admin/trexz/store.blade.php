...
@include('partials/admin.trexz.nav', ['activeTab' => 'store'])
...
@section('content-header')
    <h1>Trexz Store<small>Configure the Trexz storefront.</small></h1>
    <ol class="breadcrumb">
...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <form action="{{ route('admin.trexz.store') }}" method="POST">
                <div class="box
                    @if($enabled == 'true')
                        box-success
                    @else
                ...
                ">
                    <div class="box-header with-border">
                        <i class="fa fa-shopping-cart"></i> <h3 class="box-title">Trexz Storefront <small>Configure whether certain options for the store are enabled.</small></h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <p class="text-muted"><small>The name of the currency used for Trexz.</small></p>
                            </div>
                        </div>
                    </div>
                </div>
