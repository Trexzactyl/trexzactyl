...
@include('partials/admin.trexz.nav', ['activeTab' => 'server'])
...
@section('content-header')
    <h1>Server Settings<small>Configure Trexz's server settings.</small></h1>
    <ol class="breadcrumb">
...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <form action="{{ route('admin.trexz.server') }}" method="POST">
                <div class="box
                    @if($enabled == 'true')
                        box-success
                    @else
