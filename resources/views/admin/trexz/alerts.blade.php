...
@include('partials/admin.trexz.nav', ['activeTab' => 'alerts'])
...
@section('content-header')
    <h1>Trexz Alerts<small>Send alerts to clients via the UI.</small></h1>
    <ol class="breadcrumb">
...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <form action="{{ route('admin.trexz.alerts') }}" method="POST">
            ...
            <form action="{{ route('admin.trexz.alerts.remove') }}" method="POST">
                {!! csrf_field() !!}
