...
@include('partials/admin.trexz.nav', ['activeTab' => 'registration'])
...
@section('content-header')
    <h1>User Registration<small>Configure settings for user registration on Trexz.</small></h1>
    <ol class="breadcrumb">
...
@yield('trexz::nav')
    <div class="row">
        <div class="col-xs-12">
            <form action="{{ route('admin.trexz.registration') }}" method="POST">
                <div class="box
