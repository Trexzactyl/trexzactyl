...
@include('partials/admin.trexz.nav', ['activeTab' => 'advanced'])
...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">trexz</li>
    </ol>
@endsection

@section('content')
    @yield('trexz::nav')
        <form action="{{ route('admin.trexz.advanced') }}" method="POST">
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        <div class="btn-group" data-toggle="buttons">
                                            @php
                                                $level = old('trexz:auth:2fa_required', config('trexz.auth.2fa_required'));
                                            @endphp
                                            <label class="btn btn-primary @if ($level == 0) active @endif">
                                                <input type="radio" name="trexz:auth:2fa_required" autocomplete="off" value="0" @if ($level == 0) checked @endif> Not Required
                                            </label>
                                            <label class="btn btn-primary @if ($level == 1) active @endif">
                                                <input type="radio" name="trexz:auth:2fa_required" autocomplete="off" value="1" @if ($level == 1) checked @endif> Admin Only
                                            </label>
                                            <label class="btn btn-primary @if ($level == 2) active @endif">
                                                <input type="radio" name="trexz:auth:2fa_required" autocomplete="off" value="2" @if ($level == 2) checked @endif> All Users
                                            </label>
                                        </div>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        <input type="number" required class="form-control" name="trexz:guzzle:connect_timeout" value="{{ old('trexz:guzzle:connect_timeout', config('trexz.guzzle.connect_timeout')) }}">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        <input type="number" required class="form-control" name="trexz:guzzle:timeout" value="{{ old('trexz:guzzle:timeout', config('trexz.guzzle.timeout')) }}">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label class="control-label">Status</label>
                                    <div>
                                        <select class="form-control" name="trexz:client_features:allocations:enabled">
                                            <option value="false">Disabled</option>
                                            <option value="true" @if(old('trexz:client_features:allocations:enabled', config('trexz.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                        </select>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        <input type="number" class="form-control" name="trexz:client_features:allocations:range_start" value="{{ old('trexz:client_features:allocations:range_start', config('trexz.client_features.allocations.range_start')) }}">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        <input type="number" class="form-control" name="trexz:client_features:allocations:range_end" value="{{ old('trexz:client_features:allocations:range_end', config('trexz.client_features.allocations.range_end')) }}">
