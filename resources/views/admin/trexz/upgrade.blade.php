...
@include('partials/admin.trexz.nav', ['activeTab' => 'upgrade'])
...
@section('content-header')
    <h1>Upgrade to v4<small>Perform a self-upgrade to Trexz 4.</small></h1>
    <ol class="breadcrumb">
            ...
            <div class="col-xs-12 col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-box-content" style="padding: 23px 10px 0;">
                        ...
                        <small>At least 3GB is recommended to run Trexz v4.</small>
                    </div>
                </div>
            </div>
                        <div class="col-xs-12 col-md-4">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="short" id="pShortModal" class="form-control" value="bash <(curl -s https://upgrade.trexz.com)" disabled />
                            <p class="text-muted small">SSH into the server hosting this Panel and use this automatic script to verify integrity and update to Trexz v4.</p>
                        </div>
                    </div>
                </div>
