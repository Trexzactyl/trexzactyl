            ...
            <form action="{{ route('admin.trexzactyl.store') }}" method="POST">
                ...
                ">
                    <div class="box-header with-border">
                        <i class="fa fa-shopping-cart"></i> <h3 class="box-title">Trexzactyl Storefront <small>Configure whether certain options for the store are enabled.</small></h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <p class="text-muted"><small>The name of the currency used for Trexzactyl.</small></p>
                            </div>
                        </div>
                    </div>
                </div>
