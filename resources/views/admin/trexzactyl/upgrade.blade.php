                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="short" id="pShortModal" class="form-control" value="bash <(curl -s https://upgrade.Trexzactyl.com)" disabled />
                            <p class="text-muted small">SSH into the server hosting this Panel and use this automatic script to verify integrity and update to Trexzactyl v4.</p>
                        </div>
                    </div>
                </div>
