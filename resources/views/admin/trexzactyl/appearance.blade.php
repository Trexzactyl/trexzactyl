                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <select name="theme:admin" class="form-control">
                                        <option @if ($admin == 'trexzactyl') selected @endif value="trexzactyl">Default Theme</option>
                                    ...
                                    <p class="text-muted"><small>Determines the theme for Trexzactyl's Admin UI.</small></p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
