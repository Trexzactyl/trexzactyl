...
<html>
    <head>
        <meta charset="utf-8">
        <title>{{ config('app.name', 'Trexz') }} - @yield('title')</title>
        ...
        @section('scripts')
            ...
            <!-- Ability to customize Trexz theme -->
            <link rel="stylesheet" href="/themes/{{ config('theme.admin', 'trexz') }}/css/{{ config('theme.admin', 'trexz') }}.css">
