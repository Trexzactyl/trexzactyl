...
use Trexz\Http\Controllers\Api\Client;
use Trexz\Http\Middleware\SuspendedAccount;
use Trexz\Http\Middleware\Activity\ServerSubject;
use Trexz\Http\Middleware\Activity\AccountSubject;
use Trexz\Http\Middleware\RequireTwoFactorAuthentication;
use Trexz\Http\Middleware\Api\Client\Server\ResourceBelongsToServer;
use Trexz\Http\Middleware\Api\Client\Server\AuthenticateServerAccess;
...
Route::prefix('/')->middleware([SuspendedAccount::class])->group(function () {
    ...
    */
    ...
    Route::post('/store/earn', [Client\Store\ResourceController::class, 'earn']);
});
