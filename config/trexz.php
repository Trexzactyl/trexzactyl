...
return [
    ...
    */
    ...
    | standard Trexz shipped services.
    */
    ...
    */
    ...
    'client_features' => [
        'databases' => [
            'enabled' => env('TREXZ_CLIENT_DATABASES_ENABLED', true),
            'allow_random' => env('TREXZ_CLIENT_DATABASES_ALLOW_RANDOM', true),
        ],

        'schedules' => [
            // The total number of tasks that can exist for any given schedule at once.
            'per_schedule_task_limit' => env('TREXZ_PER_SCHEDULE_TASK_LIMIT', 10),
        ],

        'allocations' => [
            'enabled' => env('TREXZ_CLIENT_ALLOCATIONS_ENABLED', true),
            'range_start' => env('TREXZ_CLIENT_ALLOCATIONS_RANGE_START'),
            'range_end' => env('TREXZ_CLIENT_ALLOCATIONS_RANGE_END'),
        ],
    ],
    ...
    */
    ...
    'files' => [
        'max_edit_size' => env('TREXZ_FILES_MAX_EDIT_SIZE', 1024 * 1024 * 4),
    ],
    ...
    */
    ...
    'assets' => [
        'use_hash' => env('TREXZ_USE_ASSET_HASH', false),
    ],
    ...
    */
    ...
    'email' => [
        ...
        'send_install_notification' => env('TREXZ_SEND_INSTALL_NOTIFICATION', true),
        // Should an email be sent to a server owner whenever their server is reinstalled?
        'send_reinstall_notification' => env('TREXZ_SEND_REINSTALL_NOTIFICATION', true),
    ],
];
