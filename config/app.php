...
return [
    ...
    */
    ...
    | Automatic Updates
    |--------------------------------------------------------------------------
    | Allow Trexz to update itself in the background in line with the latest
    ...
    */
    ...
    | when certain Trexz features are toggled to 'on'.
    */
    'indicators' => false,
    ...
    | Is Setup
    |--------------------------------------------------------------------------
    | This variable toggles whether Trexz has been configured and is ready
    ...
    */
    ...
    'providers' => [
         ...
         */
        Trexz\Providers\ActivityLogServiceProvider::class,
        Trexz\Providers\AppServiceProvider::class,
        Trexz\Providers\AuthServiceProvider::class,
        Trexz\Providers\BackupsServiceProvider::class,
        Trexz\Providers\BladeServiceProvider::class,
        Trexz\Providers\EventServiceProvider::class,
        Trexz\Providers\HashidsServiceProvider::class,
        Trexz\Providers\RouteServiceProvider::class,
        Trexz\Providers\RepositoryServiceProvider::class,
        Trexz\Providers\ViewComposerServiceProvider::class,
    ],
    ...
    */
    ...
    'aliases' => Facade::defaultAliases()->merge([
        ...
        // Custom Facades
        'Activity' => Trexz\Facades\Activity::class,
        'LogBatch' => Trexz\Facades\LogBatch::class,
        'LogTarget' => Trexz\Facades\LogTarget::class,
    ])->toArray(),
];
